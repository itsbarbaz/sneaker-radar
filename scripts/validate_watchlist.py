...
def normalize_brand(brand):
    """
    Normalizza i nomi dei brand che KicksDB può restituire
    con denominazioni equivalenti.

    Esempio:
        HOKA
        Hoka One
        Hoka One One
    vengono trattati come lo stesso brand.
    """
...
def exact_brand_match(expected_brand, product_brand):
    return normalize_brand(expected_brand) == normalize_brand(product_brand)
